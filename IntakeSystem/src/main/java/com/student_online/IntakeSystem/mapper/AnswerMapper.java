...
public interface AnswerMapper {
    ...
    @Update("update answer set questionnaire_id=#{questionnaireId},answer_content=#{answerContent},finish_id=#{finishId},option_id=#{optionId},type=#{type} ,question_id=#{questionId} where id=#{id}")
